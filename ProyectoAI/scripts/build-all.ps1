...
Write-Host "[1/4] Building core-platform (install to local Maven repo)..." -ForegroundColor Yellow
...
Write-Host "[2/4] Building iam-service..." -ForegroundColor Yellow
...
Write-Host "[3/4] Building ai-service..." -ForegroundColor Yellow
...
Write-Host "[4/4] Building market-service..." -ForegroundColor Yellow
